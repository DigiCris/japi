...
/*!
* \brief       Read all that matches sectorsName in sectors
* \details     Search in the database sectors that matches sectorsName and returns them in an array.
* \param       (VARCHAR) sectorsName searching table by matching it.
...
*/
function getBySectorsName($sectorsName) {
    $register = new sectors();
    $success['response'] = $register->readSectorsName($sectorsName);
