...
/*!
* \brief       Read all that matches moreUsed in sectors
* \details     Search in the database sectors that matches moreUsed and returns them in an array.
* \param       (INT) moreUsed searching table by matching it.
...
*/
function getByMoreUsed($moreUsed) {
    $register = new sectors();
    $success['response'] = $register->readMoreUsed($moreUsed);
