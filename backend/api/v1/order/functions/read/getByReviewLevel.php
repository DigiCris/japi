...
/*!
* \brief       Read all that matches reviewLevel in order
* \details     Search in the database order that matches reviewLevel and returns them in an array.
* \param       (INT) reviewLevel searching table by matching it.
...
*/
function getByReviewLevel($reviewLevel) {
    $register = new order();
    $success['response'] = $register->readReviewLevel($reviewLevel);
