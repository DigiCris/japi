...
/*!
* \brief       Read all that matches Status in order
* \details     Search in the database order that matches Status and returns them in an array.
* \param       (VARCHAR) Status searching table by matching it.
...
function getByStatus($Status) {
    $register = new order();
    $success['response'] = $register->readStatus($Status);
