...
/*!
* \brief       Read all that matches deliveryId in order
* \details     Search in the database order that matches deliveryId and returns them in an array.
* \param       (INT) deliveryId searching table by matching it.
...
*/
function getByDeliveryId($deliveryId) {
    $register = new order();
    $success['response'] = $register->readDeliveryId($deliveryId);
