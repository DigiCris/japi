...
/*!
* \brief       Read all that matches shop in order
* \details     Search in the database order that matches shop and returns them in an array.
* \param       (VARCHAR) shop searching table by matching it.
...
*/
function getByShop($shop) {
    $register = new order();
    $success['response'] = $register->readShop($shop);
