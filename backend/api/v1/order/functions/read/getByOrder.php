...
/*!
* \brief       Read all that matches order in order
* \details     Search in the database order that matches order and returns them in an array.
* \param       (VARCHAR) order searching table by matching it.
...
function getByOrder($order) {
    $register = new order();
    $success['response'] = $register->readOrder($order);
