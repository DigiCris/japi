...
/*!
* \brief       Read all that matches pickAddress in order
* \details     Search in the database order that matches pickAddress and returns them in an array.
* \param       (VARCHAR) pickAddress searching table by matching it.
...
*/
function getByPickAddress($pickAddress) {
    $register = new order();
    $success['response'] = $register->readPickAddress($pickAddress);
