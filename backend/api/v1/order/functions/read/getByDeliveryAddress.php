...
/*!
* \brief       Read all that matches deliveryAddress in order
* \details     Search in the database order that matches deliveryAddress and returns them in an array.
* \param       (VARCHAR) deliveryAddress searching table by matching it.
...
*/
function getByDeliveryAddress($deliveryAddress) {
    $register = new order();
    $success['response'] = $register->readDeliveryAddress($deliveryAddress);
