...
/*!
* \brief       Read all that matches price in order
* \details     Search in the database order that matches price and returns them in an array.
* \param       (VARCHAR) price searching table by matching it.
...
function getByPrice($price) {
    $register = new order();
    $success['response'] = $register->readPrice($price);
