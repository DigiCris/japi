...
/*!
* \brief       Read all that matches shopId in order
* \details     Search in the database order that matches shopId and returns them in an array.
* \param       (INT) shopId searching table by matching it.
...
function getByShopId($shopId) {
    $register = new order();
    $success['response'] = $register->readShopId($shopId);
