...
/*!
* \brief       Read all that matches reviewDescription in order
* \details     Search in the database order that matches reviewDescription and returns them in an array.
* \param       (VARCHAR) reviewDescription searching table by matching it.
...
*/
function getByReviewDescription($reviewDescription) {
    $register = new order();
    $success['response'] = $register->readReviewDescription($reviewDescription);
