...
/*!
* \brief       Read all that matches shipDate in order
* \details     Search in the database order that matches shipDate and returns them in an array.
* \param       (DATE) shipDate searching table by matching it.
...
*/
function getByShipDate($shipDate) {
    $register = new order();
    $success['response'] = $register->readShipDate($shipDate);
