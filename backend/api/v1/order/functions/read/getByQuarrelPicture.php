...
/*!
* \brief       Read all that matches quarrelPicture in order
* \details     Search in the database order that matches quarrelPicture and returns them in an array.
* \param       (VARCHAR) quarrelPicture searching table by matching it.
...
*/
function getByQuarrelPicture($quarrelPicture) {
    $register = new order();
    $success['response'] = $register->readQuarrelPicture($quarrelPicture);
