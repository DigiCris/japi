...
/*!
* \brief       Read all that matches deliveryMoney in order
* \details     Search in the database order that matches deliveryMoney and returns them in an array.
* \param       (VARCHAR) deliveryMoney searching table by matching it.
...
*/
function getByDeliveryMoney($deliveryMoney) {
    $register = new order();
    $success['response'] = $register->readDeliveryMoney($deliveryMoney);
