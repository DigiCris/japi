...
/*!
* \brief       Read all that matches userId in order
* \details     Search in the database order that matches userId and returns them in an array.
* \param       (INT) userId searching table by matching it.
...
function getByUserId($userId) {
    $register = new order();
    $success['response'] = $register->readUserId($userId);
