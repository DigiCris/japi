...
/*!
* \brief       Read all that matches kyc in user
* \details     Search in the database user that matches kyc and returns them in an array.
* \param       (INT) kyc searching table by matching it.
