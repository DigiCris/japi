...
/*!
* \brief       Read all that matches username in user
* \details     Search in the database user that matches username and returns them in an array.
* \param       (VARCHAR) username searching table by matching it.
