...
/*!
* \brief       Read all that matches email in user
* \details     Search in the database user that matches email and returns them in an array.
* \param       (VARCHAR) email searching table by matching it.
...
function getByEmail($email) {
    $register = new user();
    $success['response'] = $register->readEmail($email);
