...
/*!
* \brief       Read all that matches rol in user
* \details     Search in the database user that matches rol and returns them in an array.
* \param       (INT) rol searching table by matching it.
