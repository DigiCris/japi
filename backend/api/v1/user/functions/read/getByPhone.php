...
/*!
* \brief       Read all that matches phone in user
* \details     Search in the database user that matches phone and returns them in an array.
* \param       (VARCHAR) phone searching table by matching it.
...
function getByPhone($phone) {
    $register = new user();
    $success['response'] = $register->readPhone($phone);
