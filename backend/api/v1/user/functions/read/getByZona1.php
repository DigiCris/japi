...
/*!
* \brief       Read all that matches zona1 in user
* \details     Search in the database user that matches zona1 and returns them in an array.
* \param       (VARCHAR) zona1 searching table by matching it.
...
*/
function getByZona1($zona1) {
    $register = new user();
    $success['response'] = $register->readZona1($zona1);
