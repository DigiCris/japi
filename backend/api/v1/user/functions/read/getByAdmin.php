...
/*!
* \brief       Read all that matches admin in user
* \details     Search in the database user that matches admin and returns them in an array.
* \param       (INT) admin searching table by matching it.
...
function getByAdmin($admin) {
    $register = new user();
    $success['response'] = $register->readAdmin($admin);
