...
/*!
* \brief       Read all that matches priceKm in user
* \details     Search in the database user that matches priceKm and returns them in an array.
* \param       (INT) priceKm searching table by matching it.
...
*/
function getByPriceKm($priceKm) {
    $register = new user();
    $success['response'] = $register->readPriceKm($priceKm);
