...
/*!
* \brief       Read all that matches zona4 in user
* \details     Search in the database user that matches zona4 and returns them in an array.
* \param       (VARCHAR) zona4 searching table by matching it.
...
*/
function getByZona4($zona4) {
    $register = new user();
    $success['response'] = $register->readZona4($zona4);
