...
/*!
* \brief       Read all that matches city in user
* \details     Search in the database user that matches city and returns them in an array.
* \param       (VARCHAR) city searching table by matching it.
...
function getByCity($city) {
    $register = new user();
    $success['response'] = $register->readCity($city);
