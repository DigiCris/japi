...
/*!
* \brief       Read all that matches password in user
* \details     Search in the database user that matches password and returns them in an array.
* \param       (VARCHAR) password searching table by matching it.
...
function getByPassword($password) {
    $register = new user();
    $success['response'] = $register->readPassword($password);
