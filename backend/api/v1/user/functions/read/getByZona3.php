...
/*!
* \brief       Read all that matches zona3 in user
* \details     Search in the database user that matches zona3 and returns them in an array.
* \param       (VARCHAR) zona3 searching table by matching it.
...
*/
function getByZona3($zona3) {
    $register = new user();
    $success['response'] = $register->readZona3($zona3);
