...
/*!
* \brief       Read all that matches lastName in user
* \details     Search in the database user that matches lastName and returns them in an array.
* \param       (VARCHAR) lastName searching table by matching it.
...
function getByLastName($lastName) {
    $register = new user();
    $success['response'] = $register->readLastName($lastName);
