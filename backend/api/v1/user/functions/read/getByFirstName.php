...
/*!
* \brief       Read all that matches firstName in user
* \details     Search in the database user that matches firstName and returns them in an array.
* \param       (VARCHAR) firstName searching table by matching it.
...
function getByFirstName($firstName) {
    $register = new user();
    $success['response'] = $register->readFirstName($firstName);
