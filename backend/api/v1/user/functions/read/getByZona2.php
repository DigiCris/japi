...
/*!
* \brief       Read all that matches zona2 in user
* \details     Search in the database user that matches zona2 and returns them in an array.
* \param       (VARCHAR) zona2 searching table by matching it.
...
*/
function getByZona2($zona2) {
    $register = new user();
    $success['response'] = $register->readZona2($zona2);
